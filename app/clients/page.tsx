      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center m-4 sm:m-8 lg:m-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            <span className="text-[#bccceb]">SPM</span> <span className="text-[#a693e5]">Clientes</span>
          </h1>
        </div>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black rounded-lg p-4 sm:p-6 lg:p-8 xl:p-12 mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-8 sm:mb-12">
            <span className="text-[#bccceb]">Nuestros</span> <span className="text-[#a693e5]">Números</span>
          </h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            <div className="text-center">
              ...
              <p className="text-[#bccceb] font-normal text-xs sm:text-sm lg:text-base mt-2">Proyectos Completados</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center">
                <span className="text-[#6c4fce] font-bold text-2xl sm:text-3xl lg:text-4xl">+</span>
              ...
              <p className="text-[#bccceb] font-normal text-xs sm:text-sm lg:text-base mt-2">Clientes Satisfechos</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center">
                <span className="text-[#6c4fce] font-bold text-2xl sm:text-3xl lg:text-4xl">+</span>
              ...
              <p className="text-[#bccceb] font-normal text-xs sm:text-sm lg:text-base mt-2">Años de Experiencia</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center">
                <CountUp
              ...
              <p className="text-[#bccceb] font-normal text-xs sm:text-sm lg:text-base mt-2">Soporte Técnico</p>
            </div>
          </div>
        </div>
